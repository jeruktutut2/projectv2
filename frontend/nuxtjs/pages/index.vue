    ...
    <div>
        <header className="fixed w-full top-0 left-0 px-2.5">
            <nav className="flex items-center justify-between mx-auto max-w-full py-[22px] px-0">
                ...
                <NuxtLink to="/login"><button className="hover:text-black border border-gray px-4 py-2 rounded hover:bg-gray-200 active:bg-gray-300 active:border-gray-500">LOGIN</button></NuxtLink>
            </nav>
        </header>
    </div>
</template>